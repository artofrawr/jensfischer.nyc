...
- **Adjacent products.** [LangGraph](/docs/tech/ai/langgraph) for orchestration, [LangSmith](/docs/tech/ai/langsmith) for tracing.
...
For agent loops specifically, [LangGraph](/docs/tech/ai/langgraph) is better-shaped than the original LangChain agent abstractions.
