...
- **Cacheable prefix.** Put the static parts (system prompt, tool definitions, few-shot examples) at the top so prompt caching works. See [Budgets](/docs/tech/ai/budgets).
