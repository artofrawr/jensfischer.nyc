...
- **Embeddings.** OpenAI `text-embedding-3-large`, Cohere `embed-v3`, Voyage. See [RAG](/docs/tech/ai/rag).
...
2. Once it works, try the smaller/cheaper model in the same family. Run [evals](/docs/tech/ai/evals). If it passes, keep it.
