...
[LangSmith](https://smith.langchain.com/) is the tracing, dataset, and eval tool from the LangChain team. It works with LangChain and [LangGraph](/docs/tech/ai/langgraph) natively, but you can use it with any LLM call via its SDK.
