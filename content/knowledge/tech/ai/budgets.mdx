...
2. **Smaller model for sub-tasks.** Use Haiku, Mini, or Flash for classification, extraction, routing. Save the frontier model for the hard step. See [Routing](/knowledge/tech/ai/routing).
