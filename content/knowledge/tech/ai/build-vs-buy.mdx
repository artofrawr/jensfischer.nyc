...
3. **An orchestration framework.** [LangGraph](/knowledge/tech/ai/langgraph), Inngest, Temporal. When you need durable state, human-in-the-loop, or branching workflows.
4. **A managed agent platform.** [LangSmith](/knowledge/tech/ai/langsmith), AgentOps, Vellum. When ops, evals, and observability matter more than control over the loop.
