...
export default function RootLayout({
  ...
  return (
    // The font variables live on <html> because Chakra resolves its font
    // tokens there — defining them lower would leave the tokens invalid.
    <html
      lang="en"
      suppressHydrationWarning
      className={`${inter.variable} ${inconsolata.variable} ${poppins.variable}`}
    >
      <body
        style={{
      ...
      >
        <Provider>
          <SiteHeader>
            ...
            <SiteHeaderActions display={{ base: "none", md: "flex" }}>
              <CommandMenu items={getSearchableItems()} />
              <Box mx={1} h={4} w="1px" bg="border" />
              <ThemeToggle />
              <Box>
                <SocialLink
            ...
            <SiteHeaderMobileNav ml="auto">
              ...
              <Flex mt={6} borderTopWidth="1px" pt={6} align="center" gap={2}>
                <CommandMenu items={getSearchableItems()} />
                <ThemeToggle />
              </Flex>
            </SiteHeaderMobileNav>
